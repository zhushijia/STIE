...
save(STdata_sim, file="BreastCancer_FFPE_STdata_sim_nolabels.RData" )
...
setwd("/archive/SCCC/Hoshida_lab/shared/fastq/SpatialTranscriptome/10X_public_dataset/HumanBreastCancer_FFPE/count/results/STIE")
load("BreastCancer_FFPE_STdata_sim_nolabels.RData" )

########################################################################################

setwd("/archive/SCCC/Hoshida_lab/shared/fastq/SpatialTranscriptome/10X_public_dataset/HumanBreastCancer_FFPE/count/results/STIE")
pdf( "BreastCancer_FFPE_STdata_sim_cellcount_distribution.pdf" )
