...
save(STdata_sim, file="MouseBrainCortex_STdata_sim_nolabels.RData" )
...
setwd("/archive/SCCC/Hoshida_lab/shared/fastq/SpatialTranscriptome/10X_public_dataset/AdultMouseBrain_FFPE/count_cortex/results/STIE")
load("MouseBrainCortex_STdata_sim_nolabels.RData" )


########################################################################################
setwd("/archive/SCCC/Hoshida_lab/shared/fastq/SpatialTranscriptome/10X_public_dataset/AdultMouseBrain_FFPE/count_cortex/results/STIE")
pdf( "MouseBrainCortex_STdata_sim_cellcount_distribution.pdf" )
