...
image_path = '/archive/SCCC/Hoshida_lab/shared/fastq/SpatialTranscriptome/10X_public_dataset/V2_MouseBrainCoronalSection1_FFPE/CytAssist_FFPE_Mouse_Brain_Rep1_tissue_image.tif'
morph_feature_dir = "/archive/SCCC/Hoshida_lab/shared/fastq/SpatialTranscriptome/10X_public_dataset/V2_MouseBrainCoronalSection1_FFPE/CytAssist_FFPE_Mouse_Brain_Rep1_tissue_image_split_images"
selected_spots_path = '/archive/SCCC/Hoshida_lab/shared/fastq/SpatialTranscriptome/10X_public_dataset/V2_MouseBrainCoronalSection1_FFPE/Section1_Cortex2.csv'

spaceranger_outs_dir <- "/archive/SCCC/Hoshida_lab/shared/fastq/SpatialTranscriptome/10X_public_dataset/V2_MouseBrainCoronalSection1_FFPE/CytAssist_FFPE_Mouse_Brain_Rep1/outs"
