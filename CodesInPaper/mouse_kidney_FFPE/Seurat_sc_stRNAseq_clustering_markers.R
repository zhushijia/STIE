...
projectName = "NatComms_2021_MouseKidney_scRNASeq"
outputDir = paste0(workdir,"/Seurat")
buildSeurat( counts=dataSC, celltypes=celltypes, projectName, outputDir )
...
workdir="/archive/SCCC/Hoshida_lab/shared/fastq/SpatialTranscriptome/10X_public_dataset/AdultMouseKidney_FFPE/count/results/Kmeans/Seurat"
spaceranger_count_dir = "/archive/SCCC/Hoshida_lab/shared/fastq/SpatialTranscriptome/10X_public_dataset/AdultMouseKidney_FFPE/count/Visium_FFPE_Mouse_Kidney"
