...
load( paste0(STIE.dir,"/data/CodesInPaper/mouse_brain_FFPE_cortex/parameters_cortex.R") )
...
colors = c( get_my_colors(10,mode=1), get_my_colors(ncol(Signature)-10,mode=2) )
...
plot_sub_image(im=im, w=3000, h=5000, xoff=11000, yoff=8000, 
               x_scale=1, spot_coordinates=spot_coordinates, 
               contour=contour2, cell_types=cell_types, color_use=colors, plot_spot=F, plot_cell=T  )


plot_sub_image(im=im, w=2000, h=2000, xoff=10000, yoff=9000, 
               x_scale=1, spot_coordinates=spot_coordinates, 
               contour=contour2, cell_types=cell_types, color_use=colors, plot_spot=F, plot_cell=T  )
